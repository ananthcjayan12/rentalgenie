    ...
    try:
        ...
        if frappe.db.exists("Customer", customer_name):
            try:
                ...
                # If deletion fails, use a different customer name
                import random
                customer_name = f"Validation Test Customer {random.randint(100, 999)}"
        ...
        try:
            ...
            checks.append(("⚠️", "Could not clean up test customer - may need manual cleanup"))
